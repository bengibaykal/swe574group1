...
#         self.email = "john@snow.com"
#         self.password = "you_know_nothing"
#         self.user = CommunityUser.objects.create(username=self.username, email=self.email, password=self.password)
#         self.token = Token.objects.create(user=self.user)
#         self.api_authentication()
#
#         self.user_2 = CommunityUser.objects.create(username="mary", email="mary@earth.com", password="super_secret")
